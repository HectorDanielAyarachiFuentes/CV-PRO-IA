...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleFullscreenToggle = () => {
        ...
        if (isFullscreen) {
            ...
            } else if (typeof CvApp.saveState === 'function') {
                CvApp.saveState(true);
            }
    ...
    async function init() {
        ...
        // --- EVENT LISTENERS (EXPORTACIÓN Y CONTROL) ---
        downloadPdfBtn.addEventListener('click', CvApp.exporter.downloadPdf);
